...
//
//						Reportes.guardarArchivo(personaje.getTipo().toString() + " " + personaje.getNombre().toString()
//								+ "ha triunfado por " );
//					}
//
//					else {
//						System.out.println(personaje.getNombre() + " ha sido derrotado.");
//						Reportes.guardarArchivo( c2.getTipo().toString() + " " +c2.getNombre().toString() 
//								+ "ha triunfado por " + c2.name().toString() );
//					}
//				} else
